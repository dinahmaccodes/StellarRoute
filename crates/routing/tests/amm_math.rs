...
fn test_amm_constant_product_reference_vectors() {
    ...
    let (output, impact) = calc.quote_constant_product(1_000_000, 1_000_000_000_000, 1_000_000_000_000, 30).unwrap();
...
fn test_amm_reverse_quote_conformance() {
    ...
    let (recovered_in, _) = calc.quote_constant_product_reverse(amount_out, x, y, fee).unwrap();
